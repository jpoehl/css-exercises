...
### Self Check
- Does each element have a unique class name? [x]
- Did you use the grouping selector for styles that both elements share? [x]
- Did you make separate rules for the styles unique to each element? [x]
