...
### Self Check
- Did you properly chain class selectors for each rule? [x]
- Does the `proportioned` image retain its original square proportions? [x]
- Does the `distorted` image end up looking squished and, well, distorted? [x]
